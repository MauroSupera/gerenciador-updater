...
URL_SCRIPT="https://raw.githubusercontent.com/MauroSupera/gerenciador-updater/refs/heads/main/pt/p9/gerenciador_pt.sh"  # Link para o conteúdo do script no GitHub
...
NUM_AMBIENTES=9 # Número de ambientes que serão configurados.
