...
URL_SCRIPT="https://raw.githubusercontent.com/MauroSupera/gerenciador-updater/refs/heads/main/pt/p36/gerenciador_pt.sh"  # Link para o conteúdo do script no GitHub
...
NUM_AMBIENTES=36 # Número de ambientes que serão configurados.
